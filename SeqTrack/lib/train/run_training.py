...
def main():
    ...
    parser.add_argument('--script', type=str, required=False, help='Name of the train script.', default='seqtrack')
    parser.add_argument('--config', type=str, required=False, help="Name of the config file.", default='seqtrack_b256')
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', type=str, help='the directory to save checkpoints and logs', default='.')
