...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                template_frames, template_anno, meta_obj_train, template_hsi_frames = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict)
                search_frames, search_anno, meta_obj_test, search_hsi_frames = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict)
                ...
                data = TensorDict({'template_images': template_frames,
                                   'template_hsi_images': template_hsi_frames,
                                   'template_anno': template_anno['bbox'],
                                   'template_masks': template_masks,
                                   'search_images': search_frames,
                                   'search_hsi_images': search_hsi_frames,
