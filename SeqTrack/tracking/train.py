...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, help='training script name', default='seqtrack')
    parser.add_argument('--config', type=str, default='seqtrack_b256', help='yaml configure file name')
    parser.add_argument('--save_dir', type=str, help='root directory to save checkpoints, logs, and tensorboard', default='.')
